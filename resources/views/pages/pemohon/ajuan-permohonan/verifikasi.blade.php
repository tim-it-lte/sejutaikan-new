            ...
            <div class="col-sm-12 col-lg-12">
                <div class="iq-card">
                    <div class="iq-card-body">
                        ...
                        <form class="mt-5" method="POST" action="{{ route('pemohon.proses-ajuan-permohonan') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div>
                                ...
                                <div class="alert alert-danger" role="alert">
                                    <p style="font-style: italic;">
                                        Apakah Anda Yakin dengan Data Permohonan yang anda ingin kirim jika Ya tekan kirim jika tidak tekan cancel !
                                    </p>
                                </div>
                            </div>
                            <div class="form-inline">
                                <a href="{{ route('pemohon.ajukan-permohonan') }}" class="btn btn-danger">Cancel</a>&nbsp;&nbsp;
