...
@section('title','Action Selesai Pengujian')
                ...
                <div class="iq-card">
                    <div class="iq-card-body">
                        <div class="text-center">
                            <h4 class="mb-3">Action Selesai Pengujian</h4>
                        </div>
                        <form method="POST" action="{{ route('pengujian.selesai-pengujian-proses',['id' => $permohonan->id]) }}">
                            @csrf
                            <div class="mb-3">
                                @php
                                    $no = 1;
                            ...
                            @foreach($parameters_select as $value)
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="{{ 'imetode_uji'.$no }}" class="form-control @error('metode_uji'.$no) is-invalid @enderror" id="{{ 'metode_uji'.$no }}" name="{{ 'metode_uji'.$no }}" value="{{ old('metode_uji'.$no) }}">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <input type="text" id="{{ 'ihasil_satu'.$no }}"  class="form-control @error('hasil_satu'.$no) is-invalid @enderror" id="{{ 'hasil_satu'.$no }}" name="{{ 'hasil_satu'.$no }}" step="any" value="{{ old('hasil_satu'.$no) }}">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <input type="text" id="{{ 'ihasil_dua'.$no }}" class="form-control @error('hasil_dua'.$no) is-invalid @enderror" id="{{ 'hasil_dua'.$no }}" name="{{ 'hasil_dua'.$no }}" step="any" value="{{ old('hasil_dua'.$no) }}">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <input type="text" id="{{ 'ihasil_tiga'.$no }}" class="form-control @error('hasil_tiga'.$no) is-invalid @enderror" id="{{ 'hasil_tiga'.$no }}" name="{{ 'hasil_tiga'.$no }}" step="any" value="{{ old('hasil_tiga'.$no) }}">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <input type="text" id="{{ 'ihasil_empat'.$no }}" class="form-control @error('hasil_empat'.$no) is-invalid @enderror" id="{{ 'hasil_empat'.$no }}" name="{{ 'hasil_empat'.$no }}" step="any" value="{{ old('hasil_empat'.$no) }}">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <input type="text" id="{{ 'ihasil_lima'.$no }}" class="form-control @error('hasil_lima'.$no) is-invalid @enderror" id="{{ 'hasil_lima'.$no }}" name="{{ 'hasil_lima'.$no }}" step="any" value="{{ old('hasil_lima'.$no) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="{{ 'istandar_mutu'.$no }}" class="form-control @error('standar_mutu'.$no) is-invalid @enderror" id="{{ 'standar_mutu'.$no }}" name="{{ 'standar_mutu'.$no }}" step="any" value="{{ old('standar_mutu'.$no) }}">
