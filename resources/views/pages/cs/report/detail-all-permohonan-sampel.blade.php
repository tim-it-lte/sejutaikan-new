                        ...
                        <form>
                            <div class="mb-5">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('kode_sampel') is-invalid @enderror" name="kode_sampel" id="exampleInputText5" placeholder="..." value="{{ old('kode_sampel', $permohonan->kode_sampel_lab != NULL ? $permohonan->kode_sampel_lab : '') }}" autocomplete="off">
                                    @error('kode_sampel')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
