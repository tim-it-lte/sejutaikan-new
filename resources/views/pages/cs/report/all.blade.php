                ...
                <div class="iq-card">
                    <div class="iq-card-body">
                        <div id="table" class="table-editable">
                            <form action="{{ route('cs.all.report') }}" method="GET">
                                ...
                                <a href="{{ route('cs.all.pdf-report',['bulan' => $get_bulan, 'tahun' => $get_tahun]) }}" class="btn btn-sm btn-success btn-block" target="_blank">Export</a>
                                <a href="{{ route('cs.all.report') }}" class="btn btn-sm btn-danger btn-block">Reset</a>
                            </form>
                        </div>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function() {
            $('#data_users_side').DataTable( {
                ajax: {
                    "url" : "{{ route('cs.datatable-all.report',['tahun' => $get_tahun, 'bulan' => $get_bulan]) }}",
                    "type" : "GET"
                },
                columns: [
                    { data: 0 },
