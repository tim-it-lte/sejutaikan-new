                ...
                <div class="iq-card">
                    ...
                    <div class="iq-card-body">
                        <span class="table-add float-right mb-5 mr-2">
                            <a style="filter: drop-shadow(3px 10px 4px black);" href="{{ route('admin.pengumuman.create') }}" class="btn btn-sm iq-bg-success">
    ...
    <script>
        $(function() {
            $('#data_users_side').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.pengumuman.all-datatables') }}",
            });
        });
    </script>
    ...
    <script>
        function delData(id)
        {
            if(confirm("Data akan dihapus ?")){
                $.ajax({
                    url: "{{ url('/admin/delete-pengumuman') }}"+'/'+id,
                    type:'GET',
                    data: {},
