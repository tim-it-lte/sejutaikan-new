                ...
                <div class="iq-card">
                    ...
                    <div class="iq-card-body">
                        <span class="table-add float-right mb-5 mr-2">
                            <a style="filter: drop-shadow(3px 10px 4px black);" href="{{ route('admin.jenis-permohonan.create') }}" class="btn btn-sm iq-bg-success">
    ...
    <script>
        $(function() {
            $('#data_users_side').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.jenis-permohonan.all-datatables') }}",
            });
        });
    </script>
    ...
    <script>
        function delData(id)
        {
            if(confirm("Data akan dihapus ?")){
                $.ajax({
                    url: "{{ url('/admin/master-data/delete-jenis-permohonan') }}"+'/'+id,
                    type:'GET',
                    data: {},
