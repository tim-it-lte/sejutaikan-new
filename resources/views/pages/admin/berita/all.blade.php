...
@section('link')
    <link rel="stylesheet" type="text/css"
        href="{{ asset('app-assets/dashboard/files/bower_components/datatables.net-bs4/css/dataTables.bootstrap4.min.css') }}">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('app-assets/dashboard/files/assets/pages/data-table/css/buttons.dataTables.min.css') }}">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('app-assets/dashboard/files/bower_components/datatables.net-responsive-bs4/css/responsive.bootstrap4.min.css') }}">
@endsection
                ...
                <div class="iq-card">
                    ...
                    <div class="iq-card-body">
                        <span class="table-add float-right mb-5 mr-2">
                            <a style="filter: drop-shadow(3px 10px 4px black);" href="{{ route('admin.berita.create') }}"
                                class="btn btn-sm iq-bg-success">
                                <i class="ri-add-fill"><span class="pl-1">Tambah Berita</span></i>
                            </a>
                        </span>
    ...
    <script>
        $(function() {
            $('#data_users_side').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.berita.all-datatables') }}",
            });
        });
    </script>
    ...
    <script>
        function delData(id) {
            if (confirm("Data akan dihapus ?")) {
                $.ajax({
                    url: "{{ url('/admin/delete-berita') }}" + '/' + id,
                    type: 'GET',
                    data: {},
