                ...
                <div class="iq-card">
                    ...
                    <div class="iq-card-body">
                        <span class="table-add float-right mb-5 mr-2">
                            <a style="filter: drop-shadow(3px 10px 4px black);" href="{{ route('admin.sop.create') }}" class="btn btn-sm iq-bg-success">
                                <i class="ri-add-fill"><span class="pl-1">Tambah SOP</span></i>
                            </a>
                        </span>
    ...
    <script>
        $(function() {
            $('#data_users_side').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.sop.all-datatables') }}",
            });
        });
    </script>
