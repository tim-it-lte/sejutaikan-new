    ...
    <section class="main-our-blog page-our-blog py-5">
        ...
        <div class="container">
            <div class="blog-list wow fadeup-animation" data-wow-delay="0.2s">
                ...
                <h5 class="text-center">Belum ada post berita.</h5>
                @else
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="half-blog-card">
                            ...
                            <div class="half-blog-content">
                                ...
                                <div>
                                    <a class="text-danger stretched-link" href="{{ route('landing.detail.berita',['slug' => $item->slug_judul]) }}" title="Selengkapnya">Selengkapnya <i class="fa fa-angle-right" aria-hidden="true"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
