                    ...
                    <div class="iq-card-body">
                        <div class="text-center">
                            ...
                            @if($permohonan->status == 2)
                                <span style="float: right;"><a href="{{ route('pengangkut.diangkut') }}" class="btn btn-sm btn-primary"><i class="fa fa-undo"></i>kembali</a></span>
                            @else
                                <span style="float: right;"><a href="{{ route('pengangkut.selesai-diangkut') }}" class="btn btn-sm btn-primary"><i class="fa fa-undo"></i>kembali</a></span>
                            @endif
                        </div>
                        <form>
                            <div class="mb-5">
